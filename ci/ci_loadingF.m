function ci_loadingF(handles,img_url)
    ...
    %img2 = imadjust(img,[0 0.84],[]); 
        ...
        set(handles.bbs_txt, 'Visible', 'on');
        set(handles.bbs_txt, 'String', num2str(length(radii)));
        ...
        h = msgbox('Oops! High Contrast C(high) must have larger value than low contrast C(low)','Error','Error');
    end

    
%     hold on
%     %plot(centers(:,1),centers(:,2), 'r+');
%     line(centers(:,1),centers(:,2), 'Color', 'green', 'linewidth',3);
...
% 
%     hold on
%     line([centers2(1,1) centers2(1,1)], [p_l(1) p_r(1)], 'Color', 'Red', 'linewidth', 3 );
% 
%     line([p_l(2) p_r(2)], [centers2(1,2) centers2(1,2)], 'Color', 'Red', 'linewidth', 3 );
% 
%     line([centers2(3,1) centers2(3,1)], [p_l(3) p_r(3)],  'Color', 'Red', 'linewidth', 3);
% 
%     line([p_l(4) p_r(4)], [centers2(4,2) centers2(4,2)],  'Color', 'Red', 'linewidth', 3 );
%     hold off
% end